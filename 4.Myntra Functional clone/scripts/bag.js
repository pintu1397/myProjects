...
function displayBagSummary(){
  ...
  if (bagItemsObjects.length === 0) {
   return bagSummaryElement.innerHTML = `
     <div class="no-item">No any  item added to Bag</div>
   `;
  }
  ...
  let finalePayment = totalMRP - totalDiscount + CONVENIENCE_FEES;
  ...
  bagSummaryElement.innerHTML = `
    <div class="bag-details-container">
      ...
      <div class="price-footer">
        ...
        <span class="price-item-value">₹${finalePayment}</span>
      </div>
    </div>
    ...
    <div class="bag-item-container">
      ...
      <div class="item-right-part">
        ...
        <div class="price-container">
          <span class="current-price">${item.price.current_price
          }</span>
          <span class="original-price">${item.price.original_price
          }</span>
          <span class="discount-percentage">(${item.price. discount_percentage
          }% OFF)</span>
        </div>
